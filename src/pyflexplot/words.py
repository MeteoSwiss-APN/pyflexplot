...
# A
words.add(
    'accumulated_over', en='accumulated over', de=f'akkumuliert {s["ue"]}ber')
words.add(
    'concentration',
    en={
        '*': 'concentration',
...
words.add(
    'summed_up_over', en='summed up over', de=f'aufsummiert {s["ue"]}ber')
